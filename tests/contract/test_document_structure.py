...
RETAINED_2026_07_PLANS = {
    ...
    "2026-07-document-centric-evaluation.md",
    "2026-07-evaluation-assessment-workspace.md",
    "2026-07-isolated-evaluation-runtime.md",
    "2026-07-rudin-engineering-chain-trial.md",
    "index.md",
}
...
def test_agents_routes_tasks_problems_and_completion():
    ...
    for required in (
        ...
        "tests/contract/test_architecture_documents.py",
