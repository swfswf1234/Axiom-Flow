...
| M1 | 解析质量 | M0 | 候选路线按冻结样本评测，结果经 ADR 决定并形成质量回归。 | EXP-001、EXP-002、EXP-003、QA-001、EVAL-001 |
| M2 | 审阅工作台 | M1 | 页图、OCR、来源证据、运行版本和人工结论可逐页对照。 | BASE-004、DES-001、EVAL-001、WEB-001 |
| M3 | 知识发布 | M2 | 候选、工作簿、关系和发布版本能完整回链原始证据。 | DES-002 |
| M4 | 工程可靠性 | M0、M3 | 包边界、任务恢复、部署、访问控制与备份恢复可验证。 | BASE-003、REL-001、REG-001、ENG-001、ARCH-001、OPS-001、JOB-001 |
