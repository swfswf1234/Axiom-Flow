...
关联 ADR：`docs/adr/0005-mysql-runtime-storage.md`、`docs/adr/0010-qwen-ocr-only-rudin-trial.md`、`docs/adr/0012-backend-package-boundaries.md`
...
领域、应用、基础设施、API 和 Worker 的依赖方向见
[`runtime-architecture.md`](runtime-architecture.md)。`ParserAdapter` 和
